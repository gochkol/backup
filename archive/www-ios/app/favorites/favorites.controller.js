(function () {
  ...
  FavoritesController.$inject = ['$state', 'userData', 'userDataSet', 'workout', '$ionicLoading'];

  function FavoritesController($state, userData, userDataSet, workout, $ionicLoading) {
    var vm = this;
