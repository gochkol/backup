(function () {
  ...
  CustomizeWorkoutController.$inject = ['$scope', '$state', 'userData', 'userDataSet', 'globalDataSet', 'workout', 'workoutData', 'helpers', 'exerciser', 'modalUtils', '$ionicScrollDelegate', '$ionicHistory', '$ionicLoading', '$timeout'];

  function CustomizeWorkoutController($scope, $state, userData, userDataSet, globalDataSet, workout, workoutData, helpers, exerciser, modalUtils, $ionicScrollDelegate, $ionicHistory, $ionicLoading, $timeout){
    var vm = this;
    ...
    function scrollBottom(){
      $timeout(function(){
        $ionicScrollDelegate.scrollBy(0,99999, true);
      }, 750);
