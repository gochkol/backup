...
(function () {
  'use strict';
  angular.module('app').factory('angularFilepicker', angularFilepicker);
  angularFilepicker.$inject = [
    '$q',
    '$log'
  ];
  function angularFilepicker($q, $log) {
    var factory = { chooseFile: chooseFile };
    return factory;
...
(function () {
  ...
  function configProvider() {
    ...
    function configFactory($http, $location) {
      ...
      function setEnv() {
        //        env = "production";
        env = 'staging';  //      var url = $location.absUrl();
                          //
                          //        if(url.indexOf("localhost") != -1){
                          //          env = "development";
                          //        }
