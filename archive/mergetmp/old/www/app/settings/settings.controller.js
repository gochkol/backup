(function () {
  ...
  SettingsController.$inject = ['$state', 'Upload', 'globalData', 'globalDataSet', 'userData', 'userDataSet', 'constants', 'config', 'infoFactory', '$ionicLoading', '$timeout'];

  function SettingsController($state, Upload, globalData, globalDataSet, userData, userDataSet, constants, config, infoFactory, $ionicLoading, $timeout) {
    var vm = this;
