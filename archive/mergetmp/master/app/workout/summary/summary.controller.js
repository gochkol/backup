(function () {
  ...
  SummaryController.$inject = ['$scope', '$state', '$cordovaNetwork', 'userData', 'userDataSet', 'globalDataSet', 'workout', 'workoutData', 'helpers', 'infoFactory', 'modalUtils', '$ionicHistory', '$ionicLoading', '$timeout'];

  function SummaryController($scope, $state, $cordovaNetwork, userData, userDataSet, globalDataSet, workout, workoutData, helpers, infoFactory, modalUtils, $ionicHistory, $ionicLoading, $timeout){
    var vm = this;
