(function () {
  ...
  LocationsController.$inject = ['$state', 'globalData', 'userData', 'globalDataSet', 'userDataSet', 'infoFactory', 'helpers'];

  function LocationsController($state, globalData, userData, globalDataSet, userDataSet, infoFactory, helpers) {
    var vm = this;
