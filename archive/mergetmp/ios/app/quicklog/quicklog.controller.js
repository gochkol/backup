(function () {
  ...
  QuickLogController.$inject = ['$state', 'helpers', 'modalUtils', 'userData', 'globalDataSet', 'userDataSet', 'infoFactory'];

  function QuickLogController($state, helpers, modalUtils, userData, globalDataSet, userDataSet, infoFactory){
    var vm = this;
