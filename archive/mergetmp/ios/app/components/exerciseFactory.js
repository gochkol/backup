(function(){
  ...
  exerciser.$inject = ['$interval', '$state', '$cordovaMedia', 'userData', 'workout', '$ionicLoading', '$timeout'];

  function exerciser($interval, $state, $cordovaMedia, userData, workout, $ionicLoading, $timeout){
