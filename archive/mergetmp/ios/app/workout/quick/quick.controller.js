(function () {
  ...
  QuickWorkoutController.$inject = ['$state', 'helpers', 'globalData', 'globalDataSet', 'userData', 'userDataSet', 'workout', 'infoFactory', '$ionicLoading', '$timeout'];

  function QuickWorkoutController($state, helpers, globalData, globalDataSet, userData, userDataSet, workout, infoFactory, $ionicLoading, $timeout){
    var vm = this;
