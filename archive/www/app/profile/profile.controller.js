(function () {
  ...
  ProfileController.$inject = ['$filter', '$state', 'globalData', 'userData', 'globalDataSet', 'userDataSet', 'helpers', '$timeout', '$ionicLoading', 'workout'];

  function ProfileController($filter, $state, globalData, userData, globalDataSet, userDataSet, helpers, $timeout, $ionicLoading, workout) {
    var vm = this;
