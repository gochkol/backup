(function () {
  ...
  QuickWorkoutController.$inject = ['$state', 'helpers', 'globalData', 'globalDataSet', 'userData', 'userDataSet', 'workout', '$ionicLoading', '$timeout', '$ionicScrollDelegate'];

  function QuickWorkoutController($state, helpers, globalData, globalDataSet, userData, userDataSet, workout, $ionicLoading, $timeout, $ionicScrollDelegate){
    var vm = this;
