(function () {
  ...
  FriendsController.$inject = ['$state', '$scope', '$stateParams', 'userData', 'userDataSet', 'globalData', 'globalDataSet', '$ionicLoading', '$timeout', 'helpers'];

  function FriendsController($state, $scope, $stateParams, userData, userDataSet, globalData, globalDataSet, $ionicLoading, $timeout, helpers){
    var vm = this;
