(function () {
  ...
  CustomizeWorkoutController.$inject = ['$scope', '$state', 'userData', 'userDataSet', 'globalDataSet', 'workout', 'workoutData', 'helpers', 'infoFactory', 'exerciser', 'modalUtils'];
