(function(){
  ...
  workout.$inject = ['$q', '$rootScope', '$interval', '$state', 'modalUtils', 'data', 'globalData', 'userData'];

  function workout($q, $rootScope, $interval, $state, modalUtils, data, globalData, userData) {
    var dataInfo;
    var dataInfoLookup = {};
