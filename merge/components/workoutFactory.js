(function(){
  ...
  workout.$inject = ['$q', '$rootScope', '$interval', '$state', 'modalUtils', 'data', 'globalData', 'userData', 'helpers', 'config'];

  function workout($q, $rootScope, $interval, $state, modalUtils, data, globalData, userData, helpers, config){
    var dataInfo;
    var dataInfoLookup = {};
    ...
    function setGymRequest(workout){
