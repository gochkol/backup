(function () {
  ...
  LocationsController.$inject = ['$state', 'globalData', 'userData', 'globalDataSet', 'userDataSet'];

  function LocationsController($state, globalData, userData, globalDataSet, userDataSet) {
    var vm = this;
