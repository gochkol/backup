(function () {
  ...
  FriendController.$inject = ['globalData', 'userData', 'globalDataSet', 'userDataSet', 'friendData', 'helpers', '$state', 'workout'];

  function FriendController(globalData, userData, globalDataSet, userDataSet, friendData, helpers, $state, workout){
    var vm = this;
