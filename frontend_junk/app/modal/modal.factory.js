    ...
    function launch(templateType, data){
      ...
      switch (templateType){
        case 'error':
          ...
          break;
        case 'login':
		      modalConfig.templateUrl = 'app/login/login.html';
          modalConfig.controller = 'LoginController';
          thisOpenType = templateType;
          break;
        case 'facebookLink':
          modalConfig.templateUrl = 'app/modal/modalFacebookLink.html';
          thisOpenType = templateType;
          break;
        case 'facebookUnlink':
          modalConfig.templateUrl = 'app/modal/modalFacebookUnlink.html';
          thisOpenType = templateType;
          break;
		    case 'warningMessage':
