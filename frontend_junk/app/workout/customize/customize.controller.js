(function () {
  ...
  CustomizeWorkoutController.$inject = ['$scope', '$state', 'userData', 'userDataSet', 'globalDataSet', 'workout', 'workoutData', 'helpers', 'exerciser', 'modalUtils', '$timeout'];

  function CustomizeWorkoutController($scope, $state, userData, userDataSet, globalDataSet, workout, workoutData, helpers, exerciser, modalUtils, $timeout){
    var vm = this;
