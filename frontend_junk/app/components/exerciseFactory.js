(function(){
  ...
  exerciser.$inject = ['$interval', '$state', 'userData', 'ngAudio', 'workout'];
  ...
  function exerciser($interval, $state, userData, ngAudio, workout){
    ...
    function startPauseClick(vs){
      ...
      if(angular.isDefined(stop)){
        ...
        if(isSet){
          ...
          vs.navcolor = "balanced-bg";
        }else{
          vs.setBG[currentSet] = "redwell";
          vs.navcolor = "assertive-bg";
        }
    ...
    function nextIfSet(vs){
      ...
      //This adds an animation to the motivational messages
